...
#### *<center>" 어릴때 태권도를 하면서 수없이 들어온 부동자세,<br>움직이지 말아야 할 것 같은 단어 <font color='red'>'부동'</font>이다.<br>하지만 부동소수점은 영어로 <font color='#1E90FF'>floating point</font> = '소수점(point) + 둥둥 떠다닌다(floating)'<br>쉽게 말해 소수점이 움직인다는 의미다. "</center>*
...
#### *<center>" 컴퓨터에서 실수를 가지고 수행하는 모든 연산에는 언제나 작은 오차가 존재한다.<br>그래서 알파고가 이세돌한테 졌나보다. "</center>*
